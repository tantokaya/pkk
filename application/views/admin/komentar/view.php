    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center; width: 70px;">Nama</th>
                <th style="text-align: center; width: 250px;">Isi Komentar</th>
            ...
            <?php
            $no =1;
            foreach ($all_komentar as $db):
                ?>
                <tr>
                    <td style="text-align: center"><?php echo $no; ?></td>
                    <td><?php echo $db['komen_name']; ?></td>
                    <td><?php echo $db['komen_isi']; ?></td>
                    <td align="center">
                        <a href="<?php echo base_url();?>komentar/edit/<?php echo $db['komen_id'];?>" title="Edit">
                            <button class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Ubah</button></a>
                        </a>
                        <a href="<?php echo base_url();?>komentar/hapus/<?php echo $db['komen_id'];?>"
