    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center; width: 150px;">Sensor Kata</th>
                <th style="text-align: center; width: 150px;">Ganti</th>
            ...
            <?php
            $no =1;
            foreach ($all_sensor as $db):
                ?>
                <tr>
                    <td style="text-align: center"><?php echo $no; ?></td>
                    <td><?php echo $db['sensor_name']; ?></td>
                    <td><?php echo $db['sensor_ganti']; ?></td>
                    <td align="center">
                        <a href="<?php echo base_url();?>sensor/edit/<?php echo $db['sensor_id'];?>" title="Edit">
                            <button class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Ubah</button></a>
                        </a>
                        <a href="<?php echo base_url();?>sensor/hapus/<?php echo $db['sensor_id'];?>"
        ...
        <div class="box-footer">
            <a href="<?php echo base_url();?>sensor/tambah" ><button type="submit" class="btn btn-warning"><i class="fa fa-plus-circle"></i> &nbsp;Tambah</button></a>
        </div>
    </div><!-- /.box-body -->
</div><!-- /.box -->
<!-- jQuery 2.0.2 -->
