    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center; width: 250px;">Tag</th>
                <th style="text-align: center; width: 250px;">Tag Permalink</th>
            ...
            <?php
            $no =1;
            foreach ($all_tag as $db):
                ?>
                <tr>
                    <td style="text-align: center"><?php echo $no; ?></td>
                    <td><?php echo $db['tag_name']; ?></td>
                    <td><?php echo $db['tag_seo']; ?></td>
                    <td align="center">
                        <a href="<?php echo base_url();?>tag/edit/<?php echo $db['tag_id'];?>" title="Edit">
                            <button class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Ubah</button></a>
                        </a>
                        <a href="<?php echo base_url();?>tag/hapus/<?php echo $db['tag_id'];?>"
        ...
        <div class="box-footer">
            <a href="<?php echo base_url();?>tag/tambah" ><button type="submit" class="btn btn-warning"><i class="fa fa-plus-circle"></i> &nbsp;Tambah</button></a>
        </div>
    </div><!-- /.box-body -->
</div><!-- /.box -->
<!-- jQuery 2.0.2 -->
