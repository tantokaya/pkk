    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center; width: 100px;">Widget</th>
            ...
            foreach ($all_kategori as $db):
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="<?php echo base_url();?>kategori/edit/<?php echo $db['kategori_id'];?>" title="Edit">
                            <button class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Ubah</button></a>
                        </a>
                        <a href="<?php echo base_url();?>kategori/hapus/<?php echo $db['kategori_id'];?>"
        ...
        <div class="box-footer">
            <a href="<?php echo base_url();?>kategori/tambah" ><button type="submit" class="btn btn-warning"><i class="fa fa-plus-circle"></i> &nbsp;Tambah</button></a>
        </div>
    </div><!-- /.box-body -->
</div><!-- /.box -->
<!-- jQuery 2.0.2 -->
