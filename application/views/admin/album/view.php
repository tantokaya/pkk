    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center; width: 350px;">Judul Album</th>
            ...
            <?php
            $no =1;
            foreach ($all_album as $db):
                ?>
                <tr>
                    <td style="text-align: center"><?php echo $no; ?></td>
                    <td style="text-align: center;">
                        <?php if($db['album_image']!='') { ?>
                        <img src="<?php echo base_url();?>uploads/album/<?php echo $db['album_image']; ?>" style="width: 80px; height: 80px;">
                        <?php } else { ?>
                    ...
                    <td align="center">
                        <a href="<?php echo base_url();?>album/edit/<?php echo $db['album_id'];?>" title="Edit">
                            <button class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Ubah</button></a>
                        </a>
                        <a href="<?php echo base_url();?>album/hapus/<?php echo $db['album_id'];?>"
        ...
        <div class="box-footer">
            <a href="<?php echo base_url();?>album/tambah" ><button type="submit" class="btn btn-warning"><i class="fa fa-plus-circle"></i> &nbsp;Tambah</button></a>
        </div>
    </div><!-- /.box-body -->
</div><!-- /.box -->
<!-- jQuery 2.0.2 -->
