    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center; width: 200px;">Pertanyaan</th>
            ...
            <?php
            $no =1;
            foreach ($all_pooling as $db):
                ?>
                <tr>
                    <td style="text-align: center"><?php echo $no; ?></td>
                    <td><?php echo $db['pertanyaan']; ?></td>
                    <td align="center">
                        <a href="<?php echo base_url();?>pooling/edit/<?php echo $db['id'];?>" title="Edit">
